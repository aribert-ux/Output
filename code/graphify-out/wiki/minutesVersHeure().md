...
> God node · 5 connections · [C:\Users\STE0059945\Documents\Coding\Output\code\code.js](file:///C:/Users/STE0059945/Documents/Coding/Output/code/code.js#L108)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as minutesVersHeure()
    ...
    participant P10 as calculerPlanningTournee()
    participant P11 as heureVersMinutes()
    participant P12 as validerLivraisonFraisNuit()
    ...
    participant P18 as calculerPlanningAvecPauses()
    participant P19 as magasinDisponible()
    P0->>+ P1: calls
    P1-->>- P0: return
    P1->>+ P2: calls
    P2-->>- P1: return
